...
def run_feasibility_audit(
    *,
    ...
    metrics = {"horizon": horizon, "b1_role": b1_role, "p38_status": p38_status, "p38_mean_terminal": p38_mean, "manifest_status": manifest_result.status, "audit_regime_is_activation_gate": AUDIT_REGIME_IS_ACTIVATION_GATE, "audit_regime_unlabeled_fallback": audit_regime_label(mom60=None, mom20=None, rv20=None, dd60=None), "strategies": strategies, "populations": {k: {"eligible_windows": v.n_windows, "excluded": len(v.exclusions)} for k, v in populations.items()}}
