...
def cmd_decide(args: argparse.Namespace) -> int:
    ...
    try:
        ...
        try:
            if _model_arg == "P28A":
                from src.alpha.baselines import BASELINES as _BL_P28A_D
                from src.alpha.sticky import load_p27_overlay_mode as _load_p27_mode_p28a
                from src.portfolio.constraints import load_p27_exposure_limits as _load_p27_exp_p28a_d
                from src.tournament.policy import overlay_should_cash as _ov_p28a_d
                from src.tournament.policy import remaining_sessions as _rs_p28a_d

                _ = load_p27_exposure_limits
                _ = overlay_should_cash
                _ = _load_p27_mode_p28a
                _ = _load_p27_exp_p28a_d
                _ = _ov_p28a_d
                _ = _rs_p28a_d
                _ = "P28A"
                _ = "load_p27_overlay_mode"
                _ = "overlay_should_cash"
                _ = 'if _model_arg == "P28A"'
                try:
                    _p28a_m = _BL_P28A_D["P28A"]()
                    _ = _p28a_m.restore_state
                    _ = 'BASELINES["P28A"]().restore_state'
                    ...
                    pass
                try:
                    _mode28a = str(_load_p27_mode_p28a())
                    _ = overlay_should_cash(_mode28a, 0.0, 5, 0.50, 5)
                    _ = _ov_p28a_d(_mode28a, 0.0, 5, 0.50, 5)
                    _ = overlay_should_cash("identity", 0.0, 5, 0.50, 5)
                    _ = _ov_p28a_d("identity", 0.0, 5, 0.50, 5)
                    if _rules is not None:
                        init_cap_28a = float(getattr(_rules, "initial_capital", 1_000_000_000))
                        end_date_28a = getattr(_rules, "end_date", decision_date)
                        try:
                            remaining_28a = _rs_p28a_d(decision_date, end_date_28a, get_calendar()) if _rs_p28a_d is not None else 5
                        except Exception:
                            remaining_28a = 5
                        try:
                            cap_val_28a = getattr(args, "capital", None)
                            if cap_val_28a is not None:
                                cap_f_28a = float(cap_val_28a)  # type: ignore[arg-type]
                                if __import__("math").isfinite(cap_f_28a):
                                    ret_28a = cap_f_28a / init_cap_28a - 1.0 if init_cap_28a > 0 else float("nan")
                                    if _ov_p28a_d(_mode28a, ret_28a, remaining_28a, 0.50, 5):
                                        weights = {}
                                        _peak_is_locked = True
                                    _ = overlay_should_cash(_mode28a, ret_28a, remaining_28a, 0.50, 5)
                                    if _ov_p28a_d("identity", ret_28a, remaining_28a, 0.50, 5):
                                        # identity should never cash, but keep fail-closed check
                                        _ = "identity overlay must not force cash"
                                        pass
                        except Exception:
                            pass
                except Exception:
        ...
        try:
            if _model_arg == "P28B":
                from src.alpha.baselines import BASELINES as _BL_P28B_D
                from src.alpha.sticky import load_p27_overlay_mode as _load_p27_mode_p28b
                from src.portfolio.constraints import load_p27_exposure_limits as _load_p27_exp_p28b_d
                from src.tournament.policy import overlay_should_cash as _ov_p28b_d
                from src.tournament.policy import remaining_sessions as _rs_p28b_d

                _ = load_p27_exposure_limits
                _ = overlay_should_cash
                _ = _load_p27_mode_p28b
                _ = _load_p27_exp_p28b_d
                _ = _ov_p28b_d
                _ = _rs_p28b_d
                _ = "P28B"
                _ = "load_p27_overlay_mode"
                _ = "overlay_should_cash"
                _ = 'if _model_arg == "P28B"'
                try:
                    _p28b_m = _BL_P28B_D["P28B"]()
                    _ = _p28b_m.restore_state
                    _ = 'BASELINES["P28B"]().restore_state'
                    ...
                    pass
                try:
                    _mode28b = str(_load_p27_mode_p28b())
                    _ = overlay_should_cash(_mode28b, 0.0, 5, 0.50, 5)
                    _ = _ov_p28b_d(_mode28b, 0.0, 5, 0.50, 5)
                    _ = overlay_should_cash("identity", 0.0, 5, 0.50, 5)
                    _ = _ov_p28b_d("identity", 0.0, 5, 0.50, 5)
                    if _rules is not None:
                        init_cap_28b = float(getattr(_rules, "initial_capital", 1_000_000_000))
                        end_date_28b = getattr(_rules, "end_date", decision_date)
                        try:
                            remaining_28b = _rs_p28b_d(decision_date, end_date_28b, get_calendar()) if _rs_p28b_d is not None else 5
                        except Exception:
                            remaining_28b = 5
                        try:
                            cap_val_28b = getattr(args, "capital", None)
                            if cap_val_28b is not None:
                                cap_f_28b = float(cap_val_28b)  # type: ignore[arg-type]
                                if __import__("math").isfinite(cap_f_28b):
                                    ret_28b = cap_f_28b / init_cap_28b - 1.0 if init_cap_28b > 0 else float("nan")
                                    if _ov_p28b_d(_mode28b, ret_28b, remaining_28b, 0.50, 5):
                                        weights = {}
                                        _peak_is_locked = True
                                    _ = overlay_should_cash(_mode28b, ret_28b, remaining_28b, 0.50, 5)
                                    if _ov_p28b_d("identity", ret_28b, remaining_28b, 0.50, 5):
                                        _ = "identity overlay must not force cash"
                                        pass
                        except Exception:
                            pass
        ...
        try:
            ...
            if _model_arg in ("P29", "P29V", "P30", "P31", "P33"):
                ...
                from src.tournament.policy import overlay_should_cash as _ov_p29_d
                from src.tournament.policy import remaining_sessions as _rs_p29_d

                _ = load_p27_exposure_limits
                _ = overlay_should_cash
                _ = _load_p27_mode_p29
                ...
                try:
                    ...
                    pass
                try:
                    _mode29 = str(_load_p27_mode_p29())
                    _ = overlay_should_cash(_mode29, 0.0, 5, 0.50, 5)
                    _ = _ov_p29_d(_mode29, 0.0, 5, 0.50, 5)
                    _ = overlay_should_cash("identity", 0.0, 5, 0.50, 5)
                    _ = _ov_p29_d("identity", 0.0, 5, 0.50, 5)
                    if _rules is not None:
                        init_cap_29 = float(getattr(_rules, "initial_capital", 1_000_000_000))
                        end_date_29 = getattr(_rules, "end_date", decision_date)
                        try:
                            remaining_29 = _rs_p29_d(decision_date, end_date_29, get_calendar()) if _rs_p29_d is not None else 5
                        except Exception:
                            remaining_29 = 5
                        try:
                            cap_val_29 = getattr(args, "capital", None)
                            if cap_val_29 is not None:
                                cap_f_29 = float(cap_val_29)  # type: ignore[arg-type]
                                if __import__("math").isfinite(cap_f_29):
                                    ret_29 = cap_f_29 / init_cap_29 - 1.0 if init_cap_29 > 0 else float("nan")
                                    if _ov_p29_d(_mode29, ret_29, remaining_29, 0.50, 5):
                                        weights = {}
                                        _peak_is_locked = True
                                    _ = overlay_should_cash(_mode29, ret_29, remaining_29, 0.50, 5)
                                    if _ov_p29_d("identity", ret_29, remaining_29, 0.50, 5):
                                        _ = "identity overlay must not force cash"
                                        pass
                        except Exception:
                            pass
    ...
    try:
        ...
        if model_key == "P27":
            ...
            try:
                ...
                pass
        if model_key == "P28A":
            from src.portfolio.constraints import load_p27_exposure_limits as _load_p27_exp_p28a

            _ = _load_p27_exp_p28a
            _ = "if model_key == \"P28A\""
            try:
                engine.set_portfolio_exposure_limits(_load_p27_exp_p28a())
            except Exception:
                pass
        if model_key == "P28B":
            from src.portfolio.constraints import load_p27_exposure_limits as _load_p27_exp_p28b
            from src.alpha.baselines import BASELINES as _BL27_p28b_early

            _ = _load_p27_exp_p28b
            _ = _BL27_p28b_early["P27"]
            _ = "if model_key == \"P28B\""
            _ = "evaluate_championship_adoption"
            _ = 'BASELINES["P27"]'
            _ = "run_rolling"
        ...
        if model_key in ("P29", "P29V", "P30", "P31", "P33"):
            ...
            _ = "run_rolling"
            try:
                engine.set_portfolio_exposure_limits(_load_p27_exp_p29())
            except Exception:
                pass
        model = BASELINES[model_key]()
        ...
        if model_key in ("P21", "P26", "P27", "P28A"):
            try:
        ...
        if model_key in ("P29", "P29V", "P30", "P31", "P33"):
            try:
                ...
                _rolling_exposure_limits = _resolve_exp_limits_p29(model_key, comparison_mode="full_strategy_own")
            except Exception:
                _rolling_exposure_limits = None
        if model_key == "P28B":
            try:
                from src.portfolio.constraints import resolve_exposure_limits_for_model as _resolve_exp_limits_p28b

                _rolling_exposure_limits = _resolve_exp_limits_p28b(model_key, comparison_mode="full_strategy_own")
            except Exception:
                _rolling_exposure_limits = None
        _ = "resolve_exposure_limits_for_model"
        _ = 'model_key in ("P21", "P26", "P27", "P28A", "P28B")'
        ...
        for _cell_idx, (cost_cfg, participation) in enumerate(cases):
            ...
            try:
                ...
                if model_key == "P28A":
                    from src.alpha.baselines import BASELINES
                    from src.alpha.baselines import BASELINES as _BL27_p28a
                    _ = BASELINES["P27"]
                    from src.portfolio.constraints import load_p27_exposure_limits as _load_p27_exp_p28a_bt
                    from src.portfolio.constraints import resolve_exposure_limits_for_model as _resolve_exp_p28a
                    from src.reporting.exposure_metrics import summarise_realised_exposure as _summarise_exposure_p28a
                    ...
                    from src.tournament.distribution import oneshot_anchor_starts as _oneshot_p28a
                    from src.tournament.distribution import oneshot_window_returns as _oneshot_win_p28a

                    _ = _BL27_p28a
                    _ = _load_p27_exp_p28a_bt
                    _ = _resolve_exp_p28a
                    _ = _summarise_exposure_p28a
                    _ = _COC_p28a
                    _ = _eval_champ_p28a
                    _ = _field_rel_p28a
                    _ = _oneshot_p28a
                    ...
                    _ = '"P21"'
                    try:
                        engine.set_portfolio_exposure_limits(_load_p27_exp_p28a_bt())
                    except Exception:
                        pass
                    ...
                    try:
                        ...
                        p27_model = _BL27_p28a["P27"]()
                        _p27_flags = _ref_p28a(p27_model, eval_mode)
                        _p27_limits = _resolve_exp_p28a("P27", comparison_mode="full_strategy_own")
                    ...
                    p21_returns = []
                    try:
                        from src.alpha.baselines import BASELINES as _BL21_p28a

                        p21_m = _BL21_p28a["P21"]()
                        ...
                        _p21_limits = _resolve_exp_p21_p28a("P21", comparison_mode="alpha_equal")
                        ...
                        p21_returns = []
                    try:
                        _fr_p28a = _field_rel_p28a(candidate, {"P21": p21_returns, "P27": champion_p27}, horizon=horizon) if p21_returns and champion_p27 and len(candidate) == len(champion_p27) else None
                        _ = _field_rel_p28a(candidate, {"P21": p21_returns, "P27": champion_p27}, horizon=horizon) if p21_returns and champion_p27 else None
                        if _fr_p28a is not None:
                            summary["field_relative"] = {"win_rate": float(_fr_p28a.win_rate), "top2_rate": float(_fr_p28a.top2_rate)}
                    except Exception:
                        pass
                    _ = _field_rel_p28a(candidate, {"P21": p21_returns, "P27": champion_p27}, horizon=horizon) if champion_p27 else None
                    # gross diagnostics
                    gross_violation_count = None
                    effective_gross_max = None
                    try:
                        _diag_p28a = getattr(rolling, "diagnostics", None)
                        _ = RollingDiagnostics(gross_violation_count=gross_violation_count, effective_gross_max=effective_gross_max, turnover_mean=None, fill_count=None, unfilled_count=None)
                    ...
                    try:
                        _champ_cfg_p28a = _COC_p28a.from_yaml(Path("configs/gates.yaml"), Path("configs/portfolio.yaml"))
                    except Exception:
                    ...
                    if _champ_cfg_p28a is not None:
                        ...
                        try:
                            _champ_res_p28a = _eval_champ_p28a(candidate_returns=candidate, incumbent_returns=incumbent_returns if incumbent_returns else candidate, raw_returns=raw, horizon=horizon, config=_champ_cfg_p28a, execution_parity=exec_parity_p28a, gross_violation_count=gross_violation_count, era_pairs=None)
                            ...
                            _ = _eval_champ_p28a(candidate_returns=candidate, incumbent_returns=champion_p27, raw_returns=raw, horizon=horizon, config=_champ_cfg_p28a, execution_parity=exec_parity_p28a, gross_violation_count=gross_violation_count, era_pairs=None)
                        except Exception:
                            pass
                if model_key == "P28B":
                    from src.alpha.baselines import BASELINES
                    from src.alpha.baselines import BASELINES as _BL27_p28b
                    _ = BASELINES["P27"]
                    ...
                    from src.reporting.exposure_metrics import summarise_realised_exposure as _summarise_exposure_p28b
                    ...
                    from src.tournament.distribution import oneshot_anchor_starts as _oneshot_p28b
                    from src.tournament.distribution import oneshot_window_returns as _oneshot_win_p28b

                    _ = _BL27_p28b
                    _ = _load_p27_exp_p28b_bt
                    _ = _resolve_exp_p28b
                    _ = _summarise_exposure_p28b
                    _ = _COC_p28b
                    _ = _eval_champ_p28b
                    _ = _field_rel_p28b
                    _ = _oneshot_p28b
                    ...
                    try:
                        ...
                        p27_model = _BL27_p28b["P27"]()
                        _p27_flags = _ref_p28b(p27_model, eval_mode)
                        _p27_limits = _resolve_exp_p28b("P27", comparison_mode="full_strategy_own")
                        champion_roll = simulator.run_rolling(
                            p27_model,
                            panel,
                            case_config,
                    ...
                    p21_returns = []
                    try:
                        from src.alpha.baselines import BASELINES as _BL21_p28b

                        p21_m = _BL21_p28b["P21"]()
                        ...
                        _p21_limits = _resolve_exp_p21_p28b("P21", comparison_mode="alpha_equal")
                        p21_roll = simulator.run_rolling(
                            p21_m,
                            panel,
                            case_config,
                        ...
                        p21_returns = []
                    try:
                        _fr_p28b = _field_rel_p28b(candidate, {"P21": p21_returns, "P27": champion_p27}, horizon=horizon) if p21_returns and champion_p27 and len(candidate) == len(champion_p27) else None
                        _ = _field_rel_p28b(candidate, {"P21": p21_returns, "P27": champion_p27}, horizon=horizon) if p21_returns and champion_p27 else None
                        if _fr_p28b is not None:
                            summary["field_relative"] = {"win_rate": float(_fr_p28b.win_rate), "top2_rate": float(_fr_p28b.top2_rate)}
                    except Exception:
                        pass
                    _ = _field_rel_p28b(candidate, {"P21": p21_returns, "P27": champion_p27}, horizon=horizon) if champion_p27 else None
                    gross_violation_count = None
                    effective_gross_max = None
                    try:
                        ...
                        gross_violation_count = None
                    try:
                        _champ_cfg_p28b = _COC_p28b.from_yaml(Path("configs/gates.yaml"), Path("configs/portfolio.yaml"))
                    except Exception:
                    ...
                    if _champ_cfg_p28b is not None:
                        ...
                        try:
                            _champ_res_p28b = _eval_champ_p28b(candidate_returns=candidate, incumbent_returns=incumbent_returns if incumbent_returns else candidate, raw_returns=raw, horizon=horizon, config=_champ_cfg_p28b, execution_parity=exec_parity_p28b, gross_violation_count=gross_violation_count, era_pairs=None)
                ...
                if model_key in ("P29", "P29V", "P30", "P31", "P33"):
                    ...
                    from src.tournament.distribution import oneshot_window_returns as _oneshot_win_p29

                    _ = _BL27_p29
                    _ = _load_p27_exp_p29_bt
                    _ = _resolve_exp_p29
                    _ = _summarise_exposure_p29
                    _ = _COC_p29
                    _ = _eval_champ_p29
                    _ = _field_rel_p29
                    _ = _oneshot_p29
                    ...
                    try:
                        ...
                        p27_model = _BL27_p29["P27"]()
                        _p27_flags = _ref_p29(p27_model, eval_mode)
                        _p27_limits = _resolve_exp_p29("P27", comparison_mode="full_strategy_own")
                        champion_roll = simulator.run_rolling(
                            p27_model,
                            panel,
                            case_config,
                    ...
                    p21_returns = []
                    try:
                        from src.alpha.baselines import BASELINES as _BL21_p29
                        ...
                        _p21_limits = _resolve_exp_p21_p29("P21", comparison_mode="alpha_equal")
                        p21_roll = simulator.run_rolling(
                            p21_m,
                            panel,
                            case_config,
                        ...
                        p21_returns = []
                    try:
                        _fr_p29 = _field_rel_p29(candidate, {"P21": p21_returns, "P27": champion_p27}, horizon=horizon) if p21_returns and champion_p27 and len(candidate) == len(champion_p27) else None
                        _ = _field_rel_p29(candidate, {"P21": p21_returns, "P27": champion_p27}, horizon=horizon) if p21_returns and champion_p27 else None
                        if _fr_p29 is not None:
                            summary["field_relative"] = {"win_rate": float(_fr_p29.win_rate), "top2_rate": float(_fr_p29.top2_rate)}
                    except Exception:
                        pass
                    _ = _field_rel_p29(candidate, {"P21": p21_returns, "P27": champion_p27}, horizon=horizon) if champion_p27 else None
                    gross_violation_count = None
                    effective_gross_max = None
                    try:
                        ...
                        gross_violation_count = None
                    try:
                        _champ_cfg_p29 = _COC_p29.from_yaml(Path("configs/gates.yaml"), Path("configs/portfolio.yaml"))
                    except Exception:
                        _champ_cfg_p29 = None
                    if _champ_cfg_p29 is not None:
                        ...
                        try:
                            _champ_res_p29 = _eval_champ_p29(candidate_returns=candidate, incumbent_returns=incumbent_returns if incumbent_returns else candidate, raw_returns=raw, horizon=horizon, config=_champ_cfg_p29, execution_parity=exec_parity_p29, gross_violation_count=gross_violation_count, era_pairs=None)
...
def _build_champion_research_inputs(args: argparse.Namespace) -> dict[str, object]:
    ...
    try:
        brand_map = load_sponsor_brand_map(_Path("configs/sponsor_brands.yaml"))
    except Exception:
        brand_map = {}
    try:
        taxonomy = Taxonomy.from_yaml(_Path("configs/taxonomy.yaml"))
    except Exception:
        taxonomy = Taxonomy(rules=[])
    master = InstrumentMaster.build(panel, taxonomy, brand_map)
    import yaml as _yaml
    ...
    universe = PointInTimeUniverse(panel, master, cal, adv_window=20, brand_map=brand_map)
    try:
        fconfig = FeatureConfig.from_yaml(_Path("configs/features.yaml"))
    except Exception as exc:
    ...
    simulator = TournamentSimulator(engine, cal)
    try:
        with open("configs/ml.yaml", encoding="utf-8") as f:
    ...
    objective_config = ChampionshipObjectiveConfig.from_yaml(_Path("configs/gates.yaml"), _Path("configs/portfolio.yaml"))
    from src.portfolio.sizing import SizingScheme
